...
Interactive single-page dashboard built with Next.js and Tailwind CSS. Compare two labor-market series (e.g., unemployment vs labor force participation for 16–19 year-olds), visualize them over time with shaded NBER recessions, attach notes, and export the chart as a PNG.
...
- Write a short note in the note box and click **Save note**; the note is stored in `localStorage` and keyed by the active metric/age selection.
